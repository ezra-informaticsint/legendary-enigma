...
import com.informaticsint.infoins.rules.engine.datasource.ElasticDatasource;
import com.informaticsint.infoins.rules.engine.datasource.ExternalDatasource;
import com.informaticsint.infoins.rules.service.ExternalDatasourceService;
...
public class ProfileService {
    ...
    @Autowired
    public ProfileService(Map<String, ExternalDatasource> externalDSList , ObjectMapper objectMapper) {
        for (ExternalDatasource ds : externalDSList.values()) {
            if (ds.getName().equals("ElasticSearch")&& ds instanceof ElasticDatasource) {
                client = ((ElasticDatasource) ds).getRestClient();
            }
        }
